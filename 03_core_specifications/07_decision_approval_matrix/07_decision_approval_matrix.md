...
If an Event Type expresses ?œwhat happened,??a State Model expresses ?œwhat is currently in what state,??an Evidence Model expresses ?œwhat proves that judgment,??and an Action Type expresses ?œwhat response can be taken,??then the Decision / Approval Matrix expresses ?œwho must judge and approve at what level under these conditions.??
...
Emergency bypass does not mean ?œno approval is required.??

---
title: Event Type Taxonomy Implementation Guide
version: 1.0
status: draft
...
# Event Type Taxonomy Implementation Guide
...
Implement framework structures derived from this specification. Focus: Define event naming, classification, routing, and semantic promotion rules.

---
title: AI Ontology Implementation Guide
version: 1.0
status: draft
...
Create ontology scaffolding and validation placeholders. Do not invent field-specific domain facts. Focus: Define AI output boundaries, model traces, candidates, and explanation concepts.

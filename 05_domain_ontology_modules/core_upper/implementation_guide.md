---
title: Core Upper Ontology Implementation Guide
version: 1.0
status: draft
...
# Core Upper Ontology Implementation Guide
...
Create ontology scaffolding and validation placeholders. Do not invent field-specific domain facts. Focus: Define stable upper-level concepts such as Entity, Agent, Object, Location, Time, Source, and Capability.

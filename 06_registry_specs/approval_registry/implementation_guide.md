---
title: Approval Registry Implementation Guide
version: 1.0
status: draft
...
# Approval Registry Implementation Guide
...
Implement registry DTOs, loaders, validators, and tests. Focus: Define registry structure for approval matrices.

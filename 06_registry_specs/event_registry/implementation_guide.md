---
title: Event Registry Implementation Guide
version: 1.0
status: draft
...
# Event Registry Implementation Guide
...
Implement registry DTOs, loaders, validators, and tests. Focus: Define registry structure for event types.

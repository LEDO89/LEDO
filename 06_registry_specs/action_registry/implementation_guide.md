---
title: Action Registry Implementation Guide
version: 1.0
status: draft
...
# Action Registry Implementation Guide
...
Implement registry DTOs, loaders, validators, and tests. Focus: Define registry structure for action types.
